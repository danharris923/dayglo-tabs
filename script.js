...
const albums = [
    {
        ...
        trackList: [
            ...
            { title: 'Kill The Hosers', duration: '1:44', hasBassTabs: false, hasGuitar: false },
    ...
    },
    {
        ...
        trackList: [
            ...
            { title: 'Die Sinner Die', duration: '2:14', hasBassTabs: false, hasGuitar: false },
            { title: 'Bedtime Story', duration: '4:02', hasBassTabs: false, hasGuitar: true },
            { title: 'My Girl', duration: '2:18', hasBassTabs: false, hasGuitar: false },
            ...
            { title: 'Wake Up America', duration: '3:07', hasBassTabs: false, hasGuitar: false },
            { title: 'Proud To Be A Canadian', duration: '1:56', hasBassTabs: false, hasGuitar: false },
            { title: 'Stupid World', duration: '2:30', hasBassTabs: false, hasGuitar: false },
    ...
    },
    {
        ...
        trackList: [
            ...
            { title: 'Scared of People', duration: '3:02', hasBassTabs: false, hasGuitar: false },
            ...
            { title: 'Ronald McRaygun', duration: '1:59', hasBassTabs: false, hasGuitar: false }
        ]
    },
    {
        id: 'two-dogs-fucking',
        ...
        trackList: [
            ...
            { title: 'Cash Bash', duration: '3:21', hasBassTabs: false, hasGuitar: false },
            { title: 'Piss Me Off', duration: '2:47', hasBassTabs: false, hasGuitar: false },
            { title: 'Euthanasia Day', duration: '3:03', hasBassTabs: false, hasGuitar: false },
            { title: 'The Idiot', duration: '2:39', hasBassTabs: false, hasGuitar: false },
            { title: 'Nuclear Supremacy', duration: '3:58', hasBassTabs: false, hasGuitar: false },
    ...
    },
    {
        ...
        bandMembers: 'Murray Acton (The Cretin) - Guitar/Vocals, Jesus Bonehead - Drums, Mike Jak - Bass',
        trackList: [
            { title: 'Casting Couch', duration: '3:21', hasBassTabs: false, hasGuitar: false },
            { title: 'Nikki Dial', duration: '2:47', hasBassTabs: false, hasGuitar: false },
            { title: 'Man Bites Dog', duration: '2:18', hasBassTabs: false, hasGuitar: false },
            ...
            { title: 'Open Sore', duration: '2:36', hasBassTabs: false, hasGuitar: false },
            ...
            { title: 'Drugged and Driving', duration: '2:59', hasBassTabs: false, hasGuitar: false },
            ...
            { title: 'Used to Be in Love', duration: '3:16', hasBassTabs: false, hasGuitar: false },
    ...
    },
    {
        ...
        trackList: [
            ...
            { title: '1967', duration: '2:28', hasBassTabs: false, hasGuitar: false },
            { title: 'Courage in a Can', duration: '2:53', hasBassTabs: false, hasGuitar: false },
            { title: 'Scientology', duration: '3:17', hasBassTabs: false, hasGuitar: false },
